...
using Xunit;
using EricksonLopez.DomainPrimitives.Mapster.SourceGenerators;

namespace EricksonLopez.DomainPrimitives.Mapster.SourceGenerators.Tests;

public class MapsterRegisterGeneratorTests
{
...
[EricksonLopez.DomainPrimitives.MapsterAttribute]
...
";
        ...
        var generator = new MapsterRegisterGenerator();
