...
{
    private bool _isInitialized { get; init; }
    ...
    public static Address Create(string street, string city)
    {
        ...
        var instance = new Address { Street = street, City = city, _isInitialized = true };
    ...
    /// <summary>Deconstructs the value object into its constituent components.</summary>
    public void Deconstruct(out string street, out string city)
    {
        street = Street;
        city = City;
    }
    ...
    private sealed class AddressJsonConverter : global::System.Text.Json.Serialization.JsonConverter<Address>
    {
        public override Address Read(ref global::System.Text.Json.Utf8JsonReader reader, global::System.Type typeToConvert, global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (!streetSet || streetValue is null)
                throw new global::System.Text.Json.JsonException("Required property 'Street' was missing or null in JSON object for Address.");
            if (!citySet || cityValue is null)
                throw new global::System.Text.Json.JsonException("Required property 'City' was missing or null in JSON object for Address.");
