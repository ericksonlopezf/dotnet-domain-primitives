...
(async () => {
  let failed = false;
  const mockContext = {
    repo: { owner: 'ericksonlopezf', repo: 'dotnet-domain-primitives' },
    sha: 'abc1234567890'
  };
                ...
                statuses: [
                  {
                    ...
                    target_url: 'https://github.com/ericksonlopezf/dotnet-domain-primitives/actions/runs/12345'
                  }
                ]
              }
            };
              ...
              statuses: [
                {
                  ...
                  updated_at: freshDate,
                  target_url: 'https://github.com/ericksonlopezf/dotnet-domain-primitives/actions/runs/12346'
                }
              ]
            }
          };
